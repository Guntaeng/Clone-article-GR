...
Wait And Scroll Element Into View    #require
    [Arguments]    ${locator}
    Wait Until Keyword Succeeds    5x    2s    Scroll Element Into View    ${locator}
...
Wait And Input Text with Delay    #require
    [Arguments]    ${locator}    ${text}
    Wait Until Keyword Succeeds    5x    2s    Input Text with Delay    ${locator}    ${text}
...
Wait And Click Element     #require
    [Arguments]    ${locator}
    Wait Until Keyword Succeeds    5x    2s    Click Element with Delay    ${locator}
