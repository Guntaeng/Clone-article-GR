...
Library    DataDriver    file=../resources/clone_article_goodreturnV3.csv  dialect=excel    encoding=utf-8
...
Create Article
    ...
    Wait And Press Keys    //input[contains(@id, '_vendor_no') and starts-with(@id, 'dx_')]    \\13
    Debug
